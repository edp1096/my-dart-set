...
if "%WORKING_MODE%" == "install" (
    ...
    call bin\code.cmd --extensions-dir .\data\extension --user-data-dir .\data\user-data --install-extension dart-code.dart-code 2>nul
...
copy "Dart Code.lnk" %UserProfile%\desktop /y 1>nul
